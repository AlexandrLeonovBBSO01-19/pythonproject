...
class Enemy(Entity):
    def __init__(self):
        ...
        self.initialiser((102, 107, 102),"Data/Sounds/SnowballHit.wav")
...
class Main():
    ...
    def game(self, screen, font, WIDTH, HEIGHT):
        ...
        foreground.image = pygame.image.load("Data/Textures/Foreground1.png").convert_alpha()
    ...
    def __init__(self):
        ...
        while game_state != 2:
            ...
            screen = self.setup_pygame("MireaBall", WIDTH, HEIGHT)
